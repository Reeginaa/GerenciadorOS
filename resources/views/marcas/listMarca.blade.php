                        ...
                        @foreach ($lista as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{-- <button type="button" class="btn_crud btn btn-danger btn-sm" data-toggle="tolltip"
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header bg-danger">
                    <h5 class="modal-title text-white font-weight-bold" id="deleteModalTitle">{{ __('Excluir Produto') }}</h5>
