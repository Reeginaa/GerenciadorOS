<?php
  $acao = "../Controller/statusServico.php?acao=gravar";
  if (isset($registro)) $acao .= "&idStatusServico=".$registro['idStatusServico'] //.= é mesma coisa que +=
?>
<!doctype html>
<html lang="en">
  <head>
    ...
    <title>Manutenção de Status de Serviço</title>
  </head>
  <body>
    <div class="container">
      <h1>Manutenção de Status de Serviço</h1>
