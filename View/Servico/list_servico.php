          ...
          <div class="container-fluid full-bg-img mask rgba-black-strong d-flex align-items-center
            ...
            <div class="row d-flex justify-content-center">
              ...
              <div class="container border white">
                  ...
                  <a class="btn btn-info" href="./form_servico.php">Novo</a>
                    ...
                    <tbody>
                      <?php foreach ($lista as $linha): ?>
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-warning btn-sm" href="../controller/servico.php?acao=cadastrar&id=<?php echo $linha['id']; ?>">Editar</a>
                            <a class="btn btn-danger btn-sm" href="../controller/servico.php?acao=remover&id=<?php echo $linha['id']; ?>">Excluir</a>
                          </td>
                        </tr>
                      <?php endforeach; ?>
                    </tbody>
