          ...
          <div class="collapse navbar-collapse" id="basicExampleNav">
            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-primary orange accent-2" aria-labelledby="navbarDropdownMenuLink">
                  <a class="dropdown-item" href="home.php?controller=marca">Marca</a>
                  <a class="dropdown-item" href="home.php?controller=servico">Serviço</a>
                  <a class="dropdown-item" href="home.php?controller=peca">Peça</a>
                  <a class="dropdown-item" href="home.php?controller=statusServico">Status Serviço</a>
                  <a class="dropdown-item" href="home.php?controller=tipoPessoa">Tipo Pessoa</a>
