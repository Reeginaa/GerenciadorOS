          ...
          <div class="row">
            <div class="form-group col-lg-5">
              ...
              <input class="form-control" type="date" name="dataNascimento"
                value="<?php if(isset($registro)) echo $registro['dataNascimento']; ?>">
            </div>
            <div class="form-group col-lg-7">
              <label for="">Sexo:</label>
              <input class="form-control" type="text" name="sexo"
                value="<?php if(isset($registro)) echo $registro['sexo']; ?>">
            </div>
          </div>  
          <div class="row">
            ...
            <div class="form-group col-lg-3">
              ...
              <input class="form-control" type="number" name="numero"
                value="<?php if(isset($registro)) echo $registro['numero']; ?>">
            </div>
          </div>  
          <div class="form-group">
            <label for="">Complemento:</label>
            <input class="form-control" type="text" name="complemento"
              value="<?php if(isset($registro)) echo $registro['complemento']; ?>">
          </div>
          <div class="form-group">
